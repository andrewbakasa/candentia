...
//       try {
//         // Make an API call to a route that uses your getCurrentUser action
//         // You'll need to create a new API route, e.g., /api/current-user
//         const response = await axios.get('/api/current-user');
//         const user = response.data;
//         if (user && user.email) {
//           setCurrentUser(user);
//           setValue('email', user.email); // Set the email value in the form
//           // Note: The `email` field will be disabled in the JSX below
//         }
//       } catch (error) {
...
//       if (response.status === 200 || response.status === 201) { // Assuming 201 for successful creation
//         toast.success('Member registration successful! Welcome to the team.');
//         reset(); // Clear the form
