...
      {/* ------------------------------------------------------------------
        ...
        ------------------------------------------------------------------
        - Made position sticky and adjusted z-index.
        - Removed the top/bottom padding from the Container component and placed it here 
          to ensure the sticky bar looks clean.
        - Used `mx-auto max-w-7xl` (assuming Container uses this) to constrain content.
    */}
      <div className="sticky top-0 z-40 w-full bg-white pt-4 pb-2 border-b border-gray-200 shadow-sm">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            {/* Subtitle/Total Count (Optional: only if you want a second line of text) */}
...
      </div>
    ...
    {/* ------------------------------------------------------------------
        ...
        ------------------------------------------------------------------
        - This ensures users can always navigate on small screens without scrolling to the top.
    */}
...
//   // Dummy row click handler
//   const handleRowClick = (id: string) => {
//       // Logic to navigate to or open the detailed enquiry view
//       router.push(`/enquiry/${id}`);
//   }
...
//   useEffect(() => {
//     // filter logic (kept for completeness)
//     let recordsPostTag = records;
//     if (uniquerecordId.length > 0) {
//       recordsPostTag = records?.filter(x => (x.id == uniquerecordId.trim()));
//     }
...
//     buttons.push(
//         <div key="summary" className="text-sm text-gray-600 mr-4 hidden sm:block">
//             {paginationSummary}
//         </div>
//     );
...
//     buttons.push(
//         <select
//             className='h-8 px-2 border-none rounded text-gray-600 text-sm focus:ring-0 cursor-pointer'
//             value={pageSize}
//             key={'pagesize-selector'}
//             onChange={(e) => handlePageSizeChange(e.target.value as PageSizeOption)}
//         >
...
//     // Gmail-style next/previous buttons 
//     buttons.push(
//         <button 
//             key="prev"
//             onClick={() => handlePageClick({ selected: Math.floor(itemOffset / pageSize) - 1 })}
...
//       <div className="z-51 w-full bg-white pt-4 pb-2 border-b border-gray-200">
//         
//         {/* Search Bar and Pagination */}
//         <div className={cn("flex gap-4", isMobile ? 'flex-col' : 'flex-row items-center justify-between')}>
...
//       {/* Remove padding from list wrapper to minimize space */}
//       <div className={cn("mt-0 pb-5", )}>
//         <div>
//           {
//             (
...
//                 {fListPage.map((record, index) => (
//                   <div
//                     // Remove all margin/padding here and rely on EnquiryRow internal padding
//                     className="col-span-1" 
//                     key={record.id}
//                   >
//                     {/* USE THE NEW ENQUIRY ROW COMPONENT */}
//                     <EnquiryRow
//                       record={record as Enquiry & { isRead: boolean }} // Cast to match expected type
//                       onClick={handleRowClick}
//                     />
//                   </div>
//                 ))}
...
//                         <p className="text-xl font-bold text-gray-700 mb-2">
//                             {searchTerm === "" ? 
//                                 "🎉 Inbox is empty. No new enquiries received yet." : 
//                                 `No enquiries match your search: "${searchTerm}"`
//                             }
//                         </p>
//                         <p className="text-md text-gray-500">
//                             {searchTerm === "" ? 
//                                 "Great job staying up to date! We'll alert you to new messages." : 
//                                 "Clear the search box to see all enquiries."
//                             }
//                         </p>
//                     </div>
//                 )}
