...
const EnquiresClient: React.FC<EnquiriesClientProps> = ({
  ...
  const [fListPage, setFListPage] = useState<Enquiry[]>([]); // Initialize as empty array of Enquiry
  ...
  let subtitle_ = "Enquiries received" //"Manage your projects and teams online"
