...
            <div className={cn("flex gap-4 pb-2", isMobile ? 'flex-col' : 'flex-row items-center justify-between')}> {/* Added pb-2 here */}
                
                {/* Search bar */}
...
            </div>
            ...
            {/* --- NEW INBOX STATS BAR --- */}
            <div className="flex justify-start text-sm pb-2 pt-1">
