        ...
        const result = await prisma.$transaction(async (tx) => {
            ...
            const newPO = await tx.mM_PurchaseOrder.create({
                data: {
                    ...
                    // Map camelCase from frontend to lowercase model field
                    vendorname: body.vendorName || body.vendorname, 
            ...
            // 3. Update status of Material Requirements to prevent double-ordering
            ...
            // 4. Financial Integrity: Increment Project Actual Cost
