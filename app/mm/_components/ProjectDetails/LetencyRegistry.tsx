            ...
            <div className="relative z-[50] p-6 lg:p-10 bg-white border-b border-rose-50">
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <button 
                            onClick={() => {
                                setEditingRecord({} as LatencyRecord); // Clear any previous selection
                                setActiveModal('delay');
                            }}
                            className="flex items-center gap-2 px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-md active:scale-95"
                        >
