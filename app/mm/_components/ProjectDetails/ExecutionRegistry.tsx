...
// Defining Search Scopes for Methodology Compliance
...
const ExecutionRegistry: React.FC<ExecutionRegistryProps> = ({
    ...
    return (
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden mb-6">
            ...
            {/* 3. DESKTOP VIEW (Refactored for Systemic Clarity) */}
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-50">
                        {filteredActivities.map((act) => {
                            ...
                            const tasksToDisplay = (!searchTerm || activeSearchFields.includes('task'))
                                        ...
                                        <td className="px-8 py-5 text-right">
                                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                                                ...
                                                >
                                                 ...
                                                 { onDeleteActivity && <ConfirmAction 
                                                                    onConfirm={()=>{onDeleteActivity(act.id)}} 
                                                                    itemId={act.id as string}
                                                                    action="Delete" 
                                                                    heading="Confirm Activity Deletion"
                                                    ...
                                                    {tasksToDisplay.map((task) => (
                                                        <div key={task.id} className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center justify-between group/task hover:border-indigo-300 transition-all">
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                {/* <button onClick={() => onDeleteTask && onDeleteTask(act.id, task.id)} className="p-2 text-slate-300 hover:text-rose-600"><Trash2 size={14}/></button> */}
                                                                { onDeleteTask && <ConfirmAction 
...
//                                     <button onClick={() => {()=>{deleteActivity()}; }} className="p-2 bg-slate-900 text-white rounded-lg"><Trash2 size={14}/></button>
//                                 </div>
//                             </div>
...
//                                                                     {/* <button onClick={() => { setEditingRecord(task); setSelectedActivity(act); setActiveModal('task'); }} className="p-2 text-slate-300 hover:text-indigo-600 transition-colors"><Trash2 size={14}/></button> */}
//                                                                 </div>
//                                                             </div>
//                                                         );
//                                                     })}
