...
import img from '/public/welcome-to-constructions.webp'// '/public/images/Web-developer.svg'; // Using your existing image path
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl p-1 md:p-4" id="intro-content">
        ...
        {/* 1. Main Content Block (Two Columns: Text & Image) */}
