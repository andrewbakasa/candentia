...
import img from '/public/images/Web-developer.svg'; // Using your existing image path
...
const Intro: React.FC<IntroProps> = () => {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl p-6 md:p-12" id="about">
        {/* Flex Layout: Column on small screens, Row on large screens */}
        <div className="flex flex-col lg:flex-row py-4 lg:py-8 justify-between lg:text-left" data-aos="fade-up">
          ...
          >
            ...
            <h2 className="mb-8 text-4xl sm:text-5xl font-extrabold text-blue-800 leading-tight">
              Horizon21: Excellence in <span className="text-yellow-600">Engineering</span> and Technology
            </h2>
          ...
          <div className="lg:w-1/2 flex flex-col justify-center mt-12 lg:mt-0 lg:pl-12">
            <Image 
