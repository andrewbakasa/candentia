  ...
  return (
    <>
      <div className="m-auto max-w-6xl p-4 md:p-12 h-5/6" id="about">
        <div className="flex flex-col lg:flex-row py-2 justify-between lg:text-left" data-aos="fade-up">
          <div
          ...
          >
            ...
            <ul className="space-y-6 list-none p-0">
              ...
              <li>
                <h3 className="text-lg font-semibold text-slate-700">Entrepreneurial Opportunity & Leadership</h3>
                <p className="text-sm text-slate-600 mt-2">
