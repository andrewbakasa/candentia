...
// // --- Icon Definitions (New Addition for UI Clarity) ---
// const Icon = (d: string, extraClasses = "") => (
//     <svg className={`h-4 w-4 mr-2 ${extraClasses}`} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
//         <path d={d} />
//     </svg>
...
//                     aria-label="User menu toggle"
//                 >
//                     {/* Hamburger Icon is now visible on small devices too for clarity */}
//                     <MenuIcon className="h-5 w-5" /> 
//                     <Avatar 
//                         classList="h-8 w-8 md:h-9 md:w-9" 
//                         src={currentUser?.image || 'https://placehold.co/40x40/4F46E5/FFFFFF?text=U'} 
...
//                 <div
//                     className="
//                         absolute rounded-xl shadow-2xl min-w-[240px] w-auto
//                         bg-white overflow-hidden right-0 top-14 text-sm z-50
//                     "
//                 >
//                     <div className="flex flex-col cursor-pointer divide-y divide-neutral-100">
//                         {currentUser ? (
...
//                                         <hr className="my-1 border-neutral-200" />
//                                         <div className="p-1">
//                                             <div className="px-3 py-1 text-xs font-bold text-gray-500 uppercase">Administration</div>
//                                             {currentUser?.isAdmin && (
//                                                 <MenuItem 
//                                                     icon={Icon("M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4z")}
//                                                     label="Broadcast Content" 
...
//                                             {currentUser?.isAdmin && (
//                                                 <MenuItem 
//                                                     icon={Icon("M16 11c1.65 0 3-1.35 3-3s-1.35-3-3-3-3 1.35-3 3 1.35 3 3 3zm-5 0c1.65 0 3-1.35 3-3s-1.35-3-3-3-3 1.35-3 3 1.35 3 3 3zM14 15.48c-1.47 1.25-3.32 2.02-5.38 2.37-2.31.39-4.8-.46-6.19-2.03-1.57-1.78-.96-4.22 1.41-5.63 2.15-1.28 4.75-1.53 7.02-.75 2.1.72 4.02 2.14 5.3 3.86.38.53.84 1.15 1.32 1.76l-1.3 1.3c-.45-.45-.96-.87-1.46-1.24z")}
//                                                     label="All Members" 
//                                                     onClick={() => handleMenuItemClickWithNav("/members")} 
//                                                 />
//                                             )}
...
//                                                     />
//                                                     {unreadMessages > 0 && 
//                                                         <div className="absolute top-2 right-4 h-5 w-5 bg-red-500 rounded-full flex items-center justify-center">
//                                                             <span className='text-xs text-white font-semibold'>{unreadMessages}</span>
//                                                         </div>
//                                                     }
//                                                 </div>
