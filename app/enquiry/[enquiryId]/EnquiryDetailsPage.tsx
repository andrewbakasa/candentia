...
const EnquiryDetailsClient: React.FC<EnquiryDetailsClientProps> = ({
    ...
    const handleArchiveMail = async (mailId: string) => {
        if (!isLoggedIn) {
            toast.error("You must be logged in to archive mail.");
            return;
        }
        try {
        ...
        <Container>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-lg min-h-[80vh] flex flex-col">
                ...
                <div className={cn(
                    ...
                    "border-[#FFD700]" // Gold Accent border for corporate feel
                )}>
                    ...
                    <div className="flex space-x-2">
                        ...
                        {/* Mark Read/Unread Toggle - Requires Logged In */}
                        {isLoggedIn && (
                            <button
                                onClick={() => handleReadMail(enquiry.id)}
                ...
                <div className="p-4 sm:p-6 border-t flex space-x-3 bg-gray-50 rounded-b-xl">
                    ...
                    <button
                        ...
                        className="flex items-center px-4 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-300 transition"
                    >
...
export default EnquiryDetailsClient;// // app/enquiries/[enquiryId]/EnquiryDetailsClient.tsx
// 'use client';
