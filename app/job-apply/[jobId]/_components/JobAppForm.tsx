  ...
  const onSubmit = async (values: JobApplicationFormValues) => {
    ...
    try {
      ...
      if (response.status === 201) { // 201 Created is the expected status for successful creation
        ...
        router.push(`/careers`); // Redirect to the careers list or a confirmation page
      } else {
...
//   applicantEmail: z.string().email({ message: 'A valid email is required.' }).min(1, { message: 'Email is required.' }),
//   applicantPhone: z.string().optional(), // Optional phone number
//   // For resumeUrl, in a real app, this would involve file upload.
//   // For this example, we'll treat it as a text input for a URL.
//   // In a real scenario, you'd upload the file first and get a URL.
//   resumeUrl: z.string().url({ message: 'A valid resume URL is required.' }).min(1, { message: 'Resume URL is required.' }),
//   coverLetterText: z.string().optional(), // Optional cover letter text
// });
...
//     setIsSubmitting(true);
//     try {
//       // Combine form values with the careerId
//       const dataToSend = {
//         ...values,
//         careerId: careerId, // Attach the careerId from props
//       };
...
//               {/* Resume URL (Simplified for this example) */}
//               <FormField
//                 control={form.control}
//                 name="resumeUrl"
//                 render={({ field }) => (
...
//                     </FormControl>
//                     {/* <FormDescription className="text-sm text-gray-500">
//                       In a real application, this would be a file upload. For now, please provide a direct link to your resume.
//                     </FormDescription> */}
//                     <FormMessage />
//                   </FormItem>
//                 )}
