// Example Client Component: DefectDetailView.tsx
'use client';
...
            <p className="text-sm text-gray-600 mb-3">Linked to Defect: **{defectId}**</p>
            <div className="space-y-3">
                <input type="text" placeholder="Analyst Name" className="w-full p-2 border rounded" />
...
                </select>
                <textarea placeholder="Summary of Findings/Root Cause Text" rows={3} className="w-full p-2 border rounded"></textarea>
                <button className="w-full py-2 bg-indigo-600 text-white font-semibold rounded hover:bg-indigo-700 transition">Complete Analysis</button>
            </div>
        </BaseFormCard>
    );
...
            <section className="bg-white p-4 sm:p-6 rounded-xl shadow-2xl border-t-8 border-indigo-600 mb-6 sticky top-0 z-10 lg:static lg:top-auto">
                
...
                
                <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 truncate">{defect.title}</h1>
...
                    <span className={`px-3 py-1 font-bold uppercase rounded-full text-xs sm:text-sm border-2 ${getPriorityClasses(defect.status)}`}>
...
                <div className="lg:col-span-3 bg-white shadow-xl rounded-xl p-4 sm:p-6"> {/* <<<--- Changed to lg:col-span-2 --->>> */}
                    
                    {/* Tabs for Navigation */}
                    <div className="flex flex-wrap border-b mb-6 gap-x-1 sm:gap-x-4">
...
                            
                            <h3 className="text-xl font-semibold mb-3 border-b pb-2 flex items-center text-gray-700"><Layers className="w-5 h-5 mr-2 text-indigo-500"/> Defect Root/Area Details</h3>
...
                                    className="bg-indigo-600 text-white text-sm px-3 py-1 rounded-full flex items-center hover:bg-indigo-700 transition"
                                >
...
                <div className="lg:col-span-3 space-y-6"> {/* <<<--- Changed to lg:col-span-1 --->>> */}
                    
                    {/* Key Metrics Card */}
...
                        <div className="flex flex-col sm:flex-row gap-4"> {/* Changed to flex-col gap-4 for stacked sidebar appearance */}
...
// import React, { useState, useCallback } from 'react';
// import { 
//     Bug, AlertTriangle, Clock, Target, User, Calendar, LucideIcon, FileText, Zap, Aperture, CheckCircle, Package, PlusCircle, ListTodo, Layers 
// } from 'lucide-react';
...
// const DefectDetailView: React.FC<DefectDetailViewProps> = ({ defect }) => {
...
//                 {/* LEFT COLUMN: MAIN TABS (2/3 width on desktop) */}
//                 <div className="lg:col-span-3 bg-white shadow-xl rounded-xl p-4 sm:p-6">
//                     
//                     {/* Tabs for Navigation */}
//                     <div className="flex flex-wrap border-b mb-6 gap-x-1 sm:gap-x-4">
//                         {['details', 'analysis', 'actions', 'improvement'].map((tab) => {
...
//                     <div className="bg-white shadow-xl rounded-xl p-4 sm:p-6 border-t-4 border-gray-400">
//                         <h3 className="text-xl font-bold text-gray-700 mb-4 border-b pb-2">Key Metrics</h3>
//                         <div className="flex flex-col sm:flex-row just-between">
//                             <DetailItem icon={Aperture} label="Analyses Count" value={defect.analyses.length} />
//                             <DetailItem icon={Zap} label="Actions Count" value={defect.actions.length} />
//                             <DetailItem icon={CheckCircle} label="Actions Completed" value={`${actionProgress}%`} />
//                         </div>
