...
export interface StrategyFilters {
    ...
    // 💡 NEW: Text search field for keyword matching
    searchTerm: string; 
}
...
const initialFilters: StrategyFilters = {
    ...
    year: 'ALL',
    minScore: null,
    // 💡 NEW: Initialize searchTerm to an empty string
    searchTerm: '', 
};
    ...
    return (
        <div className="bg-white p-4 lg:p-6 rounded-xl shadow-2xl border border-gray-100 sticky top-4 transition-all duration-300 h-fit">
            ...
            <div className="space-y-3">
                ...
                {/* 0. NEW: Text Search Filter */}
                <div>
                    <label htmlFor="searchTerm" className="block text-xs font-semibold text-gray-700 mb-1 flex items-center gap-1">
                    ...
                    <input
                        ...
                        placeholder="e.g., 'growth', 'client', 'tech'"
                    />
                </div>
