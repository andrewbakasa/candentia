...
// Assuming StrategyWithRBM comes from StrategyCard
import { StrategyWithRBM } from './StrategyCard'; 

// --- BASE TYPE DEFINITIONS (Expanded to include RBM structure for API) ---
...
//                 //on submit.... after saving to DB call onSAVE method with result
//                 //onSave method automatic update changes to stragy
//                 onSave(result); 
