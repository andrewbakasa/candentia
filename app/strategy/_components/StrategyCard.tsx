...
                {/* 💡 Collapse Summary and TOP Toggle Button */}
                ...
                <div className="mt-0 pb-1 border-b border-gray-200">
...
                <button 
                    onClick={() => onStrategyClick(strategy)}
                    className="mt-3 w-full py-0 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-lg transition duration-150 flex items-center justify-center gap-2 text-sm"
                >
...
                <button 
                    onClick={() => onStrategyClick(strategy)}
                    className="mt-3 w-full py-0 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold rounded-lg transition duration-150 flex items-center justify-center gap-2 text-sm"
                >
                    View Details
                </button>
            )}
