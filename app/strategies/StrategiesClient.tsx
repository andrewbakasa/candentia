...
//             // FIX: Update the state using the full, fresh data from the server.
//             // This ensures votes, goals, or any other derived data are correct.
//             setStrategies(prevStrategies => 
//                 prevStrategies.map(s => s.id === strategyId ? result : s)
//             );
...
//                     id: `temp-${Date.now()}`, // Assign a temp ID if not provided by form
//                     status: ProposalStatus.PENDING_REVIEW, 
//                     score: null, 
//                     votes: { YES: 0, NO: 0 }
//                 };
...
//             // Filter by year
//             // Note: strategy.year is expected to be a string or number that can be compared
//             const yearMatch = currentFilters.year === 'ALL' || String(strategy.year) === currentFilters.year;
...
//                     //added here , goal not visible immediately after saving untill page refresshing
//                     const newgoals = { ...s.goals };
//                     return { ...s, votes: newVotes, goals:newgoals };
//                 }
//                 return s;
//             })
//         );
