...
// // Import Prisma types (These are correct)
// import { Invoice, Customer, InvoiceItem } from '@prisma/client'; 
// // Import the component and the necessary type from the form file
// import InvoiceForm, { InvoiceFormData } from '@/app/ar/_components/features/invoices/InvoiceForm';
// import { FullInvoice } from '@/app/ar/_components/features/invoices/InvoiceForm'; // <-- IMPORT THE TYPE HERE

// // *** NOTE: The local definition of FullInvoice is REMOVED/COMMENTED OUT ***
...
//     const { invoiceId } = params;
//     const router = useRouter();
//     // Use the imported FullInvoice type
//     const [initialData, setInitialData] = useState<FullInvoice | null>(null);
//     const [loading, setLoading] = useState(true);
//     const [error, setError] = useState<string | null>(null);
...
//                     throw new Error('Failed to fetch invoice details.');
//                 }
//                 // Assert the response data to the imported type
//                 const data: FullInvoice = await response.json(); 
//                 setInitialData(data);
//             } catch (err) {
//                 console.error("Error fetching invoice:", err);
...
//     // --- Step 2: Handle Successful Update ---
//     // (Existing handlers remain correct)
//     const handleUpdateSuccess = () => {
//         alert('Invoice updated successfully!');
//         // Navigate back to the invoice view page or list
//         router.push(`/ar/invoices/${invoiceId}`); 
//     };
...
//     // Pass the fetched data to the InvoiceForm component
//     return (
//         <div className="container mx-auto p-8 max-w-4xl">
//             <h1 className="text-3xl font-bold mb-6">Edit Invoice: {initialData.invoiceNumber}</h1>
//             <InvoiceForm 
//                 initialData={initialData} // Now uses the correctly imported FullInvoice type


//                 // You need to define the onSubmit prop here as well
//                 // onSubmit={handleFormSubmit} 
//                 onSubmitSuccess={handleUpdateSuccess}
//                 isEditing={true}
//                 isSubmitting={false} // You need state management for this in this file
//                 onSubmit={function (data: InvoiceFormData): Promise<void> {
...
// import React, { useEffect, useState } from 'react';
// import { useRouter } from 'next/navigation';
// //import { InvoiceFormData } from '@/components/features/invoices/InvoiceForm'; // Assuming your form type
// //import InvoiceForm from '@/components/features/invoices/InvoiceForm'; // Assuming your form component
// import { Invoice, Customer, InvoiceItem } from '@prisma/client'; // Import Prisma types
// import InvoiceForm from '@/app/ar/_components/features/invoices/InvoiceForm';

// // Define the expected full invoice data structure for fetching
// type FullInvoice = Invoice & {
//     customer: Customer;
//     items: InvoiceItem[];
// };
