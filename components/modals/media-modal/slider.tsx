        ...
        <div className="w-full flex flex-col items-center justify-center p-4 min-h-[50vh] bg-gray-50 rounded-lg shadow-xl">
            {mediaList && mediaList?.length > 0 ? (
                <div className={cn(
                   ...
                   // 👇 Modified Code:
                !isMobile 
                    ? "w-full max-w-4xl h-[calc(100vh-10px)] md:h-[calc(100vh-20px)]" // Preserve fullView logic
                    : "w-full max-w-2xl h-auto md:h-[calc(100vh-50px)]", // 👈 Key Change: Use h-auto (or just remove the h-[...] part)
...
//                                     */}
//                                     <div className="relative p-2 text-sm text-gray-700 bg-white rounded-b-xl flex flex-col min-h-[50px] max-h-[200px]  overflow-y-auto">
//                                         {canEdit && editingMediaId === item.id ? (
//                                             <div className="flex flex-col gap-1">
//                                                 <div className='flex flex-row'>
//                                                     {urlsourceDrawing && <Hint
